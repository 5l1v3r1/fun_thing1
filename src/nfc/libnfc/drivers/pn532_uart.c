...
static nfc_device* pn532_uart_open(const nfc_context *context)
{
  char *speed_s;
  nfc_device *pnd = NULL;
  ...
  uart_flush_input(USART2);
  uart_set_speed(USART2, 115200/*ndd.speed*/);
...
struct nfc_driver pn532_uart_driver = {
